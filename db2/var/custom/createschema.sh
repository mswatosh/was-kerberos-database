...
/opt/ibm/db2/V11.5/bin/db2 UPDATE DATABASE MANAGER CONFIGURATION USING SRVCON_GSSPLUGIN_LIST IBMkrb5
/opt/ibm/db2/V11.5/bin/db2 UPDATE DATABASE MANAGER CONFIGURATION USING SRVCON_AUTH NOT_SPECIFIED
